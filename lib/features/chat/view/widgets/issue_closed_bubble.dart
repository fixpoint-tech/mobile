...
class IssueClosedBubble extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    ...
    const avatarWithSpacing = 40.0; // ~32 avatar + spacing
                ...
                GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: const Color(
                        0xFFECE6F0,
                      ), // same tone as other system bubbles
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Closed time inside the box (aligned with icon)
                          Row(
